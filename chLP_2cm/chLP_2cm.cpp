...
int main(){
    ...
    while(in.read_row(name, posX, posY, posZ)){
		for(int i = 0; i<9;i++){
			...
			if(i==1)
				outfile << name<<"_position_"<<i<<", "<<posX<<", "<<posY-10<<", "<<posZ<<std::endl;
			if(i==2)
				outfile << name<<"_position_"<<i<<", "<<posX+10<<", "<<posY<<", "<<posZ<<std::endl;
			if(i==3)
				outfile << name<<"_position_"<<i<<", "<<posX<<", "<<posY+10<<", "<<posZ<<std::endl;
			if(i==4)
				outfile << name<<"_position_"<<i<<", "<<posX-10<<", "<<posY<<", "<<posZ<<std::endl;
			if(i==5)
				outfile << name<<"_position_"<<i<<", "<<posX<<", "<<posY-20<<", "<<posZ<<std::endl;
			if(i==6)
				outfile << name<<"_position_"<<i<<", "<<posX+20<<", "<<posY<<", "<<posZ<<std::endl;
			if(i==7)
				outfile << name<<"_position_"<<i<<", "<<posX<<", "<<posY+20<<", "<<posZ<<std::endl;
			if(i==8)
				outfile << name<<"_position_"<<i<<", "<<posX-20<<", "<<posY<<", "<<posZ<<std::endl;
